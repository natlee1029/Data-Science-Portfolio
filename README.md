...
- [__Chicago Public Schools Analysis__](https://github.com/natlee1029/Data-Science-Portfolio/blob/master/Chicago%20Public%20Schools%20.ipynb): Clustering of CPS high schools utilizing PCA and KMeans to identify different groups of schools throughout the Chicago area - _(Packages used: Pandas, Sklearn, Bokeh, Geopandas, Google Places API)_
